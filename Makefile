...
OBJDIR = obj
SRC = srcs/main.cpp srcs/Location.cpp srcs/InitConfig.cpp srcs/ParseConfig.cpp srcs/HttpRequest.cpp srcs/ServerLoop.cpp srcs/HttpResponse.cpp srcs/Cgi.cpp
